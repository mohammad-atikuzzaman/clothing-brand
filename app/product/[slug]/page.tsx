...
export default function ProductDetailPage({ params }: ProductPageProps) {
  ...
  const [selectedSize, setSelectedSize] = useState<string>(
    product && product.sizes.length > 0 ? product.sizes[0] : "40"
  );
            ...
            <div>
              ...
              <div className="mt-5 p-4 bg-neutral-50 rounded-xs border border-neutral-100 flex items-baseline gap-3">
                ...
                <span className="ml-auto text-xs bg-red-100 text-red-700 font-bold px-2.5 py-1 rounded-xs uppercase tracking-wider">
                  Save {formatPrice(product.regularPrice - product.salePrice)} (50% Off)
                </span>
              </div>
              ...
              <div className="mt-6 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                ...
                <button
                  ...
                  className="flex-1 bg-[#161616] hover:bg-black text-white py-3.5 px-6 text-xs font-bold uppercase tracking-wider rounded-xs flex items-center justify-center gap-2 transition-colors shadow-sm"
                >
                ...
                <button
                  ...
                  className="flex-1 bg-[#c19b65] hover:bg-[#af8b55] text-black py-3.5 px-6 text-xs font-bold uppercase tracking-wider rounded-xs flex items-center justify-center gap-1.5 transition-colors shadow-md font-sans"
                >
        ...
        <div className="mt-16 sm:mt-20 border-t border-neutral-200 pt-10">
          <div className="flex items-center justify-center border-b border-neutral-200 pb-0 flex-wrap gap-4 sm:gap-8">
            <button
              ...
              className={`pb-4 text-xs font-bold uppercase tracking-wider border-b-2 transition-colors ${
                activeTab === "desc"
